...
function Query(optional bool bBySuperset, optional bool bInitial)
{
	...
	{
		L = FoundServer(ParseOption(Favorites[i], 1), Int(ParseOption(Favorites[i], 2)), "", "Rune", ParseOption(Favorites[i], 0));
...
{
     FavoriteCount=1
     Favorites(0)="||Nameless Den|| [EU]\57.129.45.245\7778\False"
}
