...
// ArenaGameInfo.
//=============================================================================
class ArenaGameInfo extends RuneMultiPlayer;
...
} ChampionList[4], ChallengerList[4];
...
{
	local ArenaStart Dest, Candidate[4], Best;
...
defaultproperties
{
     ...
     DefaultWeapon=None
     ScoreBoardType=Class'arena.ArenaScoreboard'
