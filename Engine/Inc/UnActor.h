...
inline UBOOL AActor::IsStaticBrush() const {return Brush!=NULL && IsA(ABrush::StaticClass()) && bStatic && !IsA(APolyobj::StaticClass());}
inline UBOOL AActor::IsMovingBrush() const {return Brush!=NULL && IsA(ABrush::StaticClass()) && !bStatic && !IsA(APolyobj::StaticClass());}
inline UBOOL AActor::IsPolyobj()	 const {return Brush!=NULL && IsA(ABrush::StaticClass()) && !bStatic && IsA(APolyobj::StaticClass());}
...
inline UPrimitive* AActor::GetPrimitive() const
{
	...
	else if( Skeletal) return Skeletal;
