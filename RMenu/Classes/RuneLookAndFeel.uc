...
// RuneLookAndFeel
//=============================================================================
class RuneLookAndFeel extends UWindowLookAndFeel;

#exec AUDIO IMPORT FILE="Sounds\Checkbox.wav" NAME=BigSelect
#exec AUDIO IMPORT FILE="Sounds\SmallSelect.wav" NAME=LittleSelect
...
//#exec AUDIO IMPORT FILE="Sounds\Uncheckbox.wav" NAME=ButtonSelect

#exec AUDIO IMPORT FILE="Sounds\MenuTopSlide.wav" NAME=TopSlide
#exec AUDIO IMPORT FILE="Sounds\MenuTopSlam.wav" NAME=TopSlam
#exec AUDIO IMPORT FILE="Sounds\MenuBottomOpen.wav" NAME=BottomOpen
#exec AUDIO IMPORT FILE="Sounds\MenuButton.wav" NAME=LeftButton
#exec AUDIO IMPORT FILE="Sounds\MenuButton2.wav" NAME=TopButton
#exec AUDIO IMPORT FILE="Sounds\MouseOver.wav" NAME=LeftMouseOver
#exec AUDIO IMPORT FILE="Sounds\MouseOver2.wav" NAME=TopMouseOver


#exec TEXTURE IMPORT NAME=StoneActiveFrame FILE=Textures\S_ActiveFrame.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneInactiveFrame FILE=Textures\S_InactiveFrame.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneActiveFrameS FILE=Textures\S_ActiveFrameS.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneInactiveFrameS FILE=Textures\S_InactiveFrameS.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#exec TEXTURE IMPORT NAME=StoneMisc FILE=Textures\S_Misc.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneButton FILE=Textures\S_SmallButton.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=RuneButtonBack FILE=Textures\S_MenuButton.bmp FLAGS=2 MIPS=OFF

// Big textures require Mip Maps in current D3D code
#exec TEXTURE IMPORT NAME=SideBack FILE=Textures\S_SideBack.bmp MIPS=OFF
#exec TEXTURE IMPORT NAME=TopBack FILE=Textures\S_TopBack.bmp MIPS=OFF

// HOV-specific textures
#exec TEXTURE IMPORT NAME=SideBackHOV1 FILE=Textures\S_SBHOV1.bmp MIPS=OFF
#exec TEXTURE IMPORT NAME=SideBackHOV2 FILE=Textures\S_SBHOV2.bmp MIPS=OFF
#exec TEXTURE IMPORT NAME=SBHOVTop FILE=Textures\S_SBHOVTop.bmp MIPS=OFF

#exec TEXTURE IMPORT NAME=StoneMenuArea FILE=Textures\S_MenuArea.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneClientAreaTiled FILE=Textures\S_ClientArea.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuTL FILE=Textures\S_MenuTL.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuT FILE=Textures\S_MenuT.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuTR FILE=Textures\S_MenuTR.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuL FILE=Textures\S_MenuL.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuR FILE=Textures\S_MenuR.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuBL FILE=Textures\S_MenuBL.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuB FILE=Textures\S_MenuB.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuBR FILE=Textures\S_MenuBR.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuHL FILE=Textures\S_MenuHL.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuHM FILE=Textures\S_MenuHM.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuHR FILE=Textures\S_MenuHR.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneMenuLine FILE=Textures\S_MenuLine.bmp GROUP="Icons" MIPS=OFF

#exec TEXTURE IMPORT NAME=StoneBarL FILE=Textures\M_BarL.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneBarTile FILE=Textures\M_BarTile.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneBarMax FILE=Textures\M_BarMax.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneBarWin FILE=Textures\M_BarWin.bmp GROUP="Icons" MIPS=OFF


#exec TEXTURE IMPORT NAME=StoneBarInL FILE=Textures\M_BarInL.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneBarInR FILE=Textures\M_BarInR.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneBarInM FILE=Textures\M_BarInM.bmp GROUP="Icons" MIPS=OFF

#exec TEXTURE IMPORT NAME=StoneBarOutL FILE=Textures\M_BarOutL.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneBarOutR FILE=Textures\M_BarOutR.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=StoneBarOutM FILE=Textures\M_BarOutM.bmp GROUP="Icons" MIPS=OFF
...
{
	// Draw frame top
	W.DrawClippedTexture(C, 0, 0, Texture'StoneMenuTL');
	W.DrawStretchedTexture(C, 2, 0, W.WinWidth-4, 2, Texture'StoneMenuT');
	W.DrawClippedTexture(C, W.WinWidth-2, 0, Texture'StoneMenuTR');

	// Draw frame bottom
	W.DrawClippedTexture(C, 0, W.WinHeight-2, Texture'StoneMenuBL');
	W.DrawStretchedTexture(C, 2, W.WinHeight-2, W.WinWidth-4, 2, Texture'StoneMenuB');
	W.DrawClippedTexture(C, W.WinWidth-2, W.WinHeight-2, Texture'StoneMenuBR');

	// Draw frame sides
	W.DrawStretchedTexture(C, 0, 2, 2, W.WinHeight-4, Texture'StoneMenuL');
	W.DrawStretchedTexture(C, W.WinWidth-2, 2, 2, W.WinHeight-4, Texture'StoneMenuR');

	// Draw client area
//	W.DrawStretchedTexture(C, 2, 2, W.WinWidth-4, W.WinHeight-4, Texture'StoneClientArea');	// for ramp
	W.Tile(C, Texture'StoneClientAreaTiled');
}
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'StoneMenuTL');
	W.DrawStretchedTexture(C, 4, 0, W.WinWidth-8, 4, Texture'StoneMenuT');
	W.DrawClippedTexture(C, W.WinWidth-4, 0, Texture'StoneMenuTR');

	W.DrawClippedTexture(C, 0, W.WinHeight-4, Texture'StoneMenuBL');
	W.DrawStretchedTexture(C, 4, W.WinHeight-4, W.WinWidth-8, 4, Texture'StoneMenuB');
	W.DrawClippedTexture(C, W.WinWidth-4, W.WinHeight-4, Texture'StoneMenuBR');

	W.DrawStretchedTexture(C, 0, 4, 4, W.WinHeight-8, Texture'StoneMenuL');
	W.DrawStretchedTexture(C, W.WinWidth-4, 4, 4, W.WinHeight-8, Texture'StoneMenuR');

	W.DrawStretchedTexture(C, 4, 4, W.WinWidth-8, W.WinHeight-8, Texture'StoneMenuArea');
}
...
function ComboList_DrawItem(UWindowComboList Combo, Canvas C, float X, float Y, float W, float H, string Text, bool bSelected)
{
	...
	if(bSelected)
	{
		Combo.DrawClippedTexture(C, X, Y, Texture'StoneMenuHL');
		Combo.DrawStretchedTexture(C, X + 4, Y, W - 8, 16, Texture'StoneMenuHM');
		Combo.DrawClippedTexture(C, X + W - 4, Y, Texture'StoneMenuHR');
		C.DrawColor.R = 0;
		C.DrawColor.G = 0;
		C.DrawColor.B = 0;
	}
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'StoneBarL');
	W.DrawStretchedTexture( C, 16, 0, W.WinWidth - 32, 16, Texture'StoneBarTile');
	W.DrawClippedTexture(C, W.WinWidth - 16, 0, Texture'StoneBarWin');
}
...
function Menu_DrawMenuBarItem(UWindowMenuBar B, UWindowMenuBarItem I, float X, float Y, float W, float H, Canvas C)
{
	if(B.Selected == I)
	{
		B.DrawClippedTexture(C, X, 0, Texture'StoneBarInL');
		B.DrawClippedTexture(C, X+W-1, 0, Texture'StoneBarInR');
		B.DrawStretchedTexture(C, X+1, 0, W-2, 16, Texture'StoneBarInM');
	}
	else
	if (B.Over == I)
	{
		B.DrawClippedTexture(C, X, 0, Texture'StoneBarOutL');
		B.DrawClippedTexture(C, X+W-1, 0, Texture'StoneBarOutR');
		B.DrawStretchedTexture(C, X+1, 0, W-2, 16, Texture'StoneBarOutM');
	}
...
function Menu_DrawPulldownMenuItem(UWindowPulldownMenu M, UWindowPulldownMenuItem Item, Canvas C, float X, float Y, float W, float H, bool bSelected)
{
	...
	if(Item.Caption == "-")
	{
		...
		C.DrawColor.G = 255;
		C.DrawColor.B = 255;
		M.DrawStretchedTexture(C, X, Y+5, W, 2, Texture'StoneMenuLine');
		return;
	}
	...
	if(bSelected)
	{
		M.DrawClippedTexture(C, X, Y, Texture'StoneMenuHL');
		M.DrawStretchedTexture(C, X + 4, Y, W - 8, 16, Texture'StoneMenuHM');
		M.DrawClippedTexture(C, X + W - 4, Y, Texture'StoneMenuHR');
	}
...
function Button_DrawSmallButton(UWindowSmallButton B, Canvas C)
{
	...
	B.DrawStretchedTextureSegment(C, 0, 0, 3, 16, 0, Y, 3, 16, Texture'StoneButton');
	B.DrawStretchedTextureSegment(C, B.WinWidth - 3, 0, 3, 16, 45, Y, 3, 16, Texture'StoneButton');
	B.DrawStretchedTextureSegment(C, 3, 0, B.WinWidth-6, 16, 3, Y, 42, 16, Texture'StoneButton');
}
...
simulated function PlayMenuSound(UWindowWindow W, MenuSound S)
{
	...
	case MS_MenuPullDown:
		Ear.PlaySound(sound'WindowOpen', SLOT_Interface);
		break;
	case MS_MenuCloseUp:
		break;
	case MS_MenuItem:
		Ear.PlaySound(sound'LittleSelect');
		break;
	case MS_ButtonSelect:
//		Ear.PlaySound(sound'ButtonSelect', SLOT_Talk);
		break;
	case MS_WindowOpen:
//		Ear.PlaySound(sound'BigSelect');
		break;
	case MS_WindowClose:
//		Ear.PlaySound(sound'WindowClose');
		break;
	case MS_ChangeTab:
		Ear.PlaySound(sound'LittleSelect');
		break;
	...
	case MS_TopSlide:
		Ear.PlaySound(sound'TopSlide', SLOT_Interface);
		break;
	case MS_TopSlam:
		Ear.PlaySound(sound'TopSlam', SLOT_Pain);
		break;
	case MS_BottomOpen:
		Ear.PlaySound(sound'BottomOpen', SLOT_None);
		break;
	case MS_LeftButton:
		Ear.PlaySound(sound'LeftButton', SLOT_Misc);
		break;
	case MS_TopButton:
		Ear.PlaySound(sound'TopButton', SLOT_Misc);
		break;
	case MS_LeftMouseOver:
		Ear.PlaySound(sound'LeftMouseOver', SLOT_None);
		break;
	case MS_TopMouseOver:
		Ear.PlaySound(sound'TopMouseOver', SLOT_None);
		break;
	case MS_WindowsStart:
		Ear.PlaySound(sound'WindowOpen', SLOT_None);
		break;
	case MS_WindowsEnd:
//		Ear.PlaySound(sound'WindowClose', SLOT_None);
		break;
	}
}
...
defaultproperties
{
     ...
     CloseBoxOffsetX=2
     CloseBoxOffsetY=2
     Active=Texture'RMenu.Icons.StoneActiveFrame'
     Inactive=Texture'RMenu.Icons.StoneInactiveFrame'
     ActiveS=Texture'RMenu.Icons.StoneActiveFrameS'
     InactiveS=Texture'RMenu.Icons.StoneInactiveFrameS'
     Misc=Texture'RMenu.Icons.StoneMisc'
     FrameTL=(W=2,H=16)
