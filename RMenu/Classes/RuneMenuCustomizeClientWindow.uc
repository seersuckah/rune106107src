class RuneMenuCustomizeClientWindow extends RuneMenuPageWindow;

var localized string LocalizedKeyName[255];
var string RealKeyName[255];
var int BoundKey1[70];
var int BoundKey2[70];
var RuneMenuLabelControl KeyNames[70];
var RuneMenuRaisedButton KeyButtons[70];
var RuneMenuRaisedButton SelectedButton;
...
var RuneMenuLabelControl JoystickHeading;
...
function Created()
{
	...
	local RuneMenuLabelControl Heading;
	local bool bTop;
	...
	for (I=0; I<ArrayCount(AliasNames); I++)
	{
		...
		if(j != -1)
		{
			if(!bTop)
				ButtonTop += 10;
			Heading = RuneMenuLabelControl(CreateControl(class'RuneMenuLabelControl', LabelLeft-10, ButtonTop+3, WinWidth, 1));
		...
		KeyNames[I] = RuneMenuLabelControl(CreateControl(class'RuneMenuLabelControl', LabelLeft, ButtonTop+3, LabelWidth, 1));
		KeyNames[I].SetText(LabelList[I]);
		KeyNames[I].SetHelpText(CustomizeHelp);
		KeyNames[I].SetFont(F_Normal);
		KeyButtons[I] = RuneMenuRaisedButton(CreateControl(class'RuneMenuRaisedButton', ButtonLeft, ButtonTop, ButtonWidth, 1));
	...
	// Joystick
	ButtonTop += 10;
	JoystickHeading = RuneMenuLabelControl(CreateControl(class'RuneMenuLabelControl', LabelLeft-10, ButtonTop+3, WinWidth, 1));
...
function Notify(UWindowDialogControl C, byte E)
{
	...
	case DE_Click:
		...
		if (RuneMenuRaisedButton(C) != None)
		{
			SelectedButton = RuneMenuRaisedButton(C);
			for ( I=0; I<AliasCount; I++ )
			{
				if (KeyButtons[I] == C)
					Selection = I;
...
defaultproperties
{
     ...
     LabelList(2)="Move Left"
     LabelList(3)="Move Right"
     LabelList(4)="Strafe"
     LabelList(5)="Turn Left"
     LabelList(6)="Turn Right"
     LabelList(7)="Jump/Up"
     LabelList(8)="Crouch/Down"
     LabelList(9)="Mouse Look"
     LabelList(10)="Look Up"
     LabelList(11)="Look Down"
     LabelList(12)="Center View"
     LabelList(13)="Zoom In"
     LabelList(14)="Zoom Out"
     LabelList(15)="Use"
     LabelList(16)="Attack"
     LabelList(17)="Defend"
     LabelList(18)="Throw Weapon"
     LabelList(19)="RUNE Power"
     LabelList(20)="Stow Weapon"
     LabelList(21)="Select Next Sword"
     LabelList(22)="Select Next Hammer"
     LabelList(23)="Select Next Axe"
     LabelList(24)="Send Message"
     LabelList(25)="Send Team Message"
     LabelList(26)="Taunt"
     LabelList(27)="Toggle Scoreboard"
     LabelList(28)="Toggle TargetStrafe"
     LabelList(29)="Quick Save"
     LabelList(30)="Quick Load"
     ...
     AliasNames(8)="Duck"
     AliasNames(9)="Look"
     AliasNames(10)="LookUp"
     AliasNames(11)="LookDown"
     AliasNames(12)="CenterView"
     AliasNames(13)="camerain"
     AliasNames(14)="cameraout"
     AliasNames(15)="Use"
     AliasNames(16)="Fire"
     AliasNames(17)="AltFire"
     AliasNames(18)="Throw"
     AliasNames(19)="Powerup"
     AliasNames(20)="SwitchWeapon 1"
     AliasNames(21)="SwitchWeapon 2"
     AliasNames(22)="SwitchWeapon 3"
     AliasNames(23)="SwitchWeapon 4"
     AliasNames(24)="Talk"
     AliasNames(25)="TeamTalk"
     AliasNames(26)="Taunt"
     AliasNames(27)="Showscores"
     AliasNames(28)="ZTargetToggle"
     AliasNames(29)="QuickSave"
     AliasNames(30)="QuickLoad"
     OrString=" or "
     CustomizeHelp="Click the rectangle on the right and then press a key to bind to this control."
     DefaultsText="Reset"
