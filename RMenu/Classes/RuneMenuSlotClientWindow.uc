class RuneMenuSlotClientWindow extends RuneMenuPageWindow
	config(user);

var globalconfig localized string SlotNames[9];
var localized string MonthNames[12];
var localized string SlotHelp;

var RuneMenuRaisedButton Slots[9];
...
function Created()
{
	...
	{
		ButtonTop = 25 + 25*I;
		Slots[I] = RuneMenuRaisedButton(CreateControl(class'RuneMenuRaisedButton', ButtonLeft, ButtonTop, ButtonWidth, 1));
