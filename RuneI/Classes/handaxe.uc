...
//		Owner.SetCollision(true, false, false);		// This was causing ragnar to get stuck inside tables
...
defaultproperties
{
     ...
     PickupMessage="You have found a Hand Axe"
