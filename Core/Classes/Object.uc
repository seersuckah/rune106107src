...
// RUNE:  
// Matter types -- Stored in Object.uc because both Actors and Texture have matter types
enum EMatterType
{
	MATTER_NONE,
	MATTER_WOOD,
...
native(662) static final function float  VSize2D( vector A );
...
function string GetToken(out string s)
{
	local int i,length;
	local string tok;
...
final simulated function float Radians(int theta)
{
	return (theta*2.0*Pi/65535.0);
}
