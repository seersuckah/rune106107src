...
var(Advanced) config array<string> PrecachePackages; // RUNE
...
defaultproperties
{
     ...
     C_Polyobj=(R=100,G=240,B=250)
     C_ThickWire=(R=128,G=128,B=128)
     C_ThinWire=(R=146,G=146,B=146)
